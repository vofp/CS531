...
In the case of the third experiment the agent does make decisions based on previous actions, and the experiment is therefor sequential.
...
While the agent with memory was gauranteed to clean the entire environment, it was actually less efficient than the memoryless agent.
Similarly suprising was that the memory-less agent had a higher percentage cleaned than the random agent.
